module.exports = {
  ...
  testMatch: [
    ...
    '<rootDir>/tests/mobileCaptureBugFixes.source.test.ts',
    ...
    '<rootDir>/tests/positioningOperationalApi.test.ts',
    ...
    '<rootDir>/tests/aisleRevisionService.test.ts',
    ...
    '<rootDir>/tests/phase3aExportResolutionInstrumentation.test.ts',
  ],
  transform: {

/**
 * SHA-256 (FIPS 180-4) for mobile fingerprints — no native crypto dependency.
 * Used for payload + prepared-asset identity (not password hashing).
 */
...
/** Prefixed fingerprint for drafts / prepared assets. */

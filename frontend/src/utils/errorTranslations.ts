...
const V3_STRUCTURED_CODE_TO_KEY: Record<string, string> = {
  ...
  SUPPLIER_PROMPT_REQUIRED: 'errors.supplier_prompt_required',
  SUPPLIER_NOT_RESOLVED: 'errors.supplier_not_resolved',
  PROCESS_VALIDATION_FAILED: 'errors.validation_generic',
  SUPPLIER_EXTRACTION_PROFILE_NOT_FOUND: 'clients.extraction_profile.not_found_error',
  SUPPLIER_EXTRACTION_PROFILE_INVALID_CONFIGURATION: 'clients.extraction_profile.invalid_configuration_error',
  SUPPLIER_EXTRACTION_PROFILE_ACTIVATION_FAILED: 'clients.extraction_profile.activation_failed_error',
  SUPPLIER_EXTRACTION_PROFILE_ROW_VERSION_CONFLICT: 'clients.extraction_profile.row_version_conflict_error',

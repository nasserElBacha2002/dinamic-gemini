"""UoW-bound finalization evidence writer (memory) — Phase 3.3."""
...
class MemoryFinalizationEvidenceWriter:
    """Buffered stage writes applied on UoW commit, discarded on rollback."""

    def __init__(self, stage_store: MemoryFinalizationStageStore) -> None:

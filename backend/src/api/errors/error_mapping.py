...
from src.api.constants.error_wire import (
    ...
    HTTP_DETAIL_GLOBAL_PROMPT_CONFIG_EMPTY_INSTRUCTIONS,
    HTTP_DETAIL_GLOBAL_PROMPT_CONFIG_INVALID_SCOPE,
    HTTP_DETAIL_GLOBAL_PROMPT_CONFIG_NOT_FOUND,
...
from src.api.errors.structured_api_http import (
    ...
    EMPTY_UPLOAD,
    GLOBAL_PROMPT_CONFIG_ACTIVATION_FAILED,
    GLOBAL_PROMPT_CONFIG_EMPTY_INSTRUCTIONS,
    GLOBAL_PROMPT_CONFIG_INVALID_SCOPE,
...
_HTTP_EXCEPTION_DISPATCH: dict[type[BaseException], Callable[[BaseException], HTTPException]] = {
    ...
    GlobalPromptConfigNotFoundError: _structured_fixed(
        404,
        error_code=GLOBAL_PROMPT_CONFIG_NOT_FOUND,
        detail=HTTP_DETAIL_GLOBAL_PROMPT_CONFIG_NOT_FOUND,
    ),
    ...
    GlobalPromptConfigEmptyInstructionsError: _structured_fixed(
        400,
        error_code=GLOBAL_PROMPT_CONFIG_EMPTY_INSTRUCTIONS,
        detail=HTTP_DETAIL_GLOBAL_PROMPT_CONFIG_EMPTY_INSTRUCTIONS,
    ),
    GlobalPromptConfigInvalidScopeError: _structured_fixed(
        400,
        error_code=GLOBAL_PROMPT_CONFIG_INVALID_SCOPE,
        detail=HTTP_DETAIL_GLOBAL_PROMPT_CONFIG_INVALID_SCOPE,
    ),
    GlobalPromptConfigActivationFailedError: _structured_fixed(
        409,
        error_code=GLOBAL_PROMPT_CONFIG_ACTIVATION_FAILED,
        detail=HTTP_DETAIL_GLOBAL_PROMPT_CONFIG_ACTIVATION_FAILED,
    ),

...
router.include_router(local_inventory_packages.router)
router.include_router(dinamic_scanner_txt_imports.router)
...
router.include_router(positioning_operational.router)

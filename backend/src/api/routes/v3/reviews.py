"""v3 position review actions: confirm, update_quantity, update_sku, delete_position."""
...
def submit_review_action(
    ...
    """Submit a manual review action (confirm, update_quantity, update_sku, delete_position)."""

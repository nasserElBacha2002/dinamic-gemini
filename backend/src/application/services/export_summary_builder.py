    ...
    def inventory_summary_row(
        ...
        *,
        ...
        return {
            ...
            "Total de posiciones": rollups.total_positions,
            "Posiciones válidas": rollups.valid_positions,
            "Posiciones inválidas": rollups.invalid_positions,
            ...
            rows.append(
                {
                    ...
                    "Total de posiciones": totals.total_positions,
                    "Posiciones válidas": totals.valid_positions,
                    "Posiciones inválidas": totals.invalid_positions,

...
class UpdateClientCommand:
    client_id: str
    name: str | None = None
    #: UNSET = leave unchanged; None = clear; mode = set.
    identification_mode: AisleIdentificationMode | None | object = UNSET
    ...
    def execute(self, command: UpdateClientCommand) -> Client:
        ...
        if command.identification_mode is not UNSET:
            ...
            if client.default_identification_mode != mode:
                client.default_identification_mode = mode  # type: ignore[assignment]
                changed = True
